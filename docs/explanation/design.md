...
Hyrum separates the work of *modifying a charm's dependencies* (patching) from the work of *running a check* (running). This separation is deliberate:
...
The `Patcher` protocol is intentionally narrow:
